    ...
    <div class="container" id='box-crop'>
        ...
        <div id="box">
            ...
            <div class="mb-3 mt-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control bg-dark text-light border-dark" id="titulo" name="titulo" placeholder="Titulo" value="TESTE">
                </div>
            </div>
                ...
                <div class="col-2">
                   <select name="estado_id" class="form-control bg-dark text-light border-dark form-select" id="estado_id">
                    ...
                    <div class="mb-3 row">
                     <div class="form-outline">
                        ...
                        <textarea name="sobre" class="form-control" id="sobre" rows="4" placeholder="">hauahuahuahauh</textarea>
                    </div>
                </div>
                   ...
                   <div class="mb-3 row">
                     <div class="form-outline">
                        ...
                        <textarea name="informacoes" class="form-control" id="informacoes" rows="4">hauahuahuahauh</textarea>
                    </div>
                </div>
...
@push('script')
<script src="{{ asset('js/cadastroTorneio.js')}}" type="text/javascript"></script>
@endpush
@endsection
