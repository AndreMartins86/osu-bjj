...
@section('conteudo')
    ...
    >
      ...
      >
        ...
        <ul
          class="flex flex-col lg:flex-row flex-wrap lg:items-center mt-3 text-sm font-medium text-gray-500 sm:mt-0"
        >
          <li>
